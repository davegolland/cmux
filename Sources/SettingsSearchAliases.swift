...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:markdown-render-math": localized("settings.search.alias.setting.app.markdown-render-math", defaultValue: "markdown.renderMath latex katex math formula equation typeset tex viewer"),
        ...
        "terminal:render-math": localized("settings.search.alias.setting.terminal.render-math", defaultValue: "terminal.renderMath latex katex math formula equation typeset tex overlay"),
