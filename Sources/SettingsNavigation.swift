...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "markdown-render-math", String(localized: "settings.app.markdownRenderMath", defaultValue: "Markdown Viewer Math"), "markdown.renderMath latex katex math formula equation typeset tex viewer"),
        ...
        setting(.terminal, "render-math", String(localized: "settings.terminal.renderMath", defaultValue: "Render Math in Terminal"), "terminal.renderMath latex katex math formula equation typeset tex overlay"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "markdown.renderMath": settingID(for: .app, idSuffix: "markdown-render-math"),
        ...
        "terminal.renderMath": settingID(for: .terminal, idSuffix: "render-math"),
