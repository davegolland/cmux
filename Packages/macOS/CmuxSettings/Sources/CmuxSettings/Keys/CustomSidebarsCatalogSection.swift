...
public struct CustomSidebarsCatalogSection: SettingCatalogSection {
    /// Which renderer a selected custom sidebar uses: `remote` (default;
    /// the crash-isolated out-of-process worker for user-authored sources) or
    /// `inProcess` (native in-host SwiftUI with real hover/focus/keyboard for
